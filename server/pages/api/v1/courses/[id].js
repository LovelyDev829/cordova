...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    ...
    const { id  } = req.query;
    try {
        const existingData = await _models_index__WEBPACK_IMPORTED_MODULE_2__.courses.findOne({
            where: {
                id: id
            }
        });
...
var __webpack_exports__ = __webpack_require__.X(0, [9851], () => (__webpack_exec__(8510)));
